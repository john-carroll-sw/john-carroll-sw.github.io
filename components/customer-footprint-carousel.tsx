...
const logoOverrides: Record<string, LogoOverride> = {
  ...
  Deloitte: { src: localLogo("deloitte"), shell: "bare", className: "customer-footprint-logo-wordmark" },
  ...
  Nike: { src: localLogo("nike"), shell: "bare", className: "customer-footprint-logo-vector" },
